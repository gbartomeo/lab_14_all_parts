...
udice1 = raw_input("What was the first dice roll?\n> ")
udice2 = raw_input("What was the second dice roll?\n> ")

if (udice1, udice2) == ("1","1"):
	print("Snake Eyes!")
elif (udice1, udice2) == ("2", "2"):
	print("Hard Four!")
elif (udice1, udice2) in [("3", "1"), ("1", "3")]:
	print("Easy Four!")
else:
